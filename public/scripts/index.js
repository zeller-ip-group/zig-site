...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inviewMin = __webpack_require__(3);
	...
	var setHeaderNavPositionOnScroll = new Waypoint({
	  element: headerNav,
	...
	var pageSections = document.querySelectorAll('[data-sectionName]');
	var headerNavItems = document.querySelectorAll('.HeaderNav li');

	function addWaypointsToSections(nodeArray) {
	  (0, _lodash2.default)(nodeArray, function (node, key) {
	    new Waypoint({
	      element: node,
	      handler: function handler(direction) {
	        if (direction === 'down') {
	          var currentSectionName = this.element.getAttribute('data-sectionName');
	          var currentSectionHeaderNavItem = document.querySelector('.HeaderNav a[href="#' + currentSectionName + '"]').parentNode;

	          (0, _lodash2.default)(headerNavItems, function (headerNavItem, key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  var formInputStyles = ['formInput-disabled', 'formInput-good', 'formInput-caution', 'formInput-warning'];
	  ...
	  function getFormMessageFields() {
	    var formMessageFields = {};
	    formMessageFields.text = document.querySelector('.ContactForm__message__text');
	    formMessageFields.button = document.querySelector('.ContactForm__message__button');
	    return formMessageFields;
	  }

	  function clearFormInputs(contactFormInputs) {
	    (0, _lodash2.default)(contactFormInputs, function (val, key) {
	      val.value = '';
	    });
	  }

	  function toggleContactFormMessageVisibility() {
	    var contactFormMessage = document.querySelector('.ContactForm__message');
	    contactFormMessage.classList.toggle('ContactForm__message--open');
	  }

	  function handleFormClick(e) {
	    e.preventDefault();
	    var messageButton = document.querySelector('.ContactForm__message__button');
	  ...
	  function renderSuccessFormMessage() {
	    var formMessageFields = getFormMessageFields();

	    formMessageFields.text.textContent = 'Thank you.  Your message was submitted succesfully';
	  ...
	  function renderFailureFormMessage() {
	    ...
	    formMessageFields.text.textContent = 'Your message was not submitted succesfully';
	  ...
	  function clearFormMessage() {
	    ...
	    formMessageFields.text.textContent = '';
	    formMessageFields.button.textContent = '';
	  }

	  function handleFormSubmit(e) {
	    e.preventDefault();
	    var contactFormInputs = getFormInputs();
	    var formInputsAreValid = validateFormInputs(contactFormInputs);
	    ...
	    if (formInputsAreValid) {
	      _axios2.default.post('/contact', {
	        ...
	        setTimeout(function () {
	          return toggleContactFormMessageVisibility();
	        }, 5000);
	  ...
	  function validateFormInputs(inputObjectToValidate) {
	    var inputObject = inputObjectToValidate;
	    var validNamePattern = /^[A-Za-z ]{3,20}$/;
	    var validEmailPattern = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;
	    var formIsValid = true;

	    (0, _lodash2.default)(inputObject, function (inputItem, key) {
	  ...
	  function addListenersToFormInputs(eventType, eventHandler) {
	    ...
	    (0, _lodash2.default)(formInputs, function (formInput, key) {
	  ...
	  function removeFormInputValidationStyles() {
	    ...
	    (0, _lodash2.default)(formInputStyles, function (style, key) {
	      _this.classList.remove(style);
	    });
	  }

	  addListenersToFormInputs('focus', removeFormInputValidationStyles);
	  contactForm.addEventListener('click', function (e) {
	    return handleFormClick(e);
	  });
	};
